...
- [x] Top left corner contains site name that is a link to the main page
...
Some of the links to resources were not working or contained older versions of code.
Some instructions were not updated to current versions.

## License

Copyright 2026 Christopher Dombele
